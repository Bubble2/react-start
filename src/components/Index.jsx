                ...
                <Layout>
                    <Header className="header">
                        <Menu theme="dark" mode="horizontal" style={{ lineHeight: '64px' }}>
                            ...
                            <Menu.Item key="2"><NavLink to="/demo">DEMO1</NavLink></Menu.Item>
                            <Menu.Item key="3"><NavLink to="/demo2">DEMO2</NavLink></Menu.Item>
                            <Menu.Item key="4"><NavLink to="/demo3">DEMO3</NavLink></Menu.Item>
                        </Menu>
                    </Header>
                    <Layout>
